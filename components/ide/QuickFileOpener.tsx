    ...
    return (
        <>
            ...
            <div className="fixed top-20 left-1/2 -translate-x-1/2 w-full max-w-2xl z-50">
                <div className="bg-theme-sidebar border border-theme-border rounded-lg shadow-2xl overflow-hidden">
                    {/* Search Input */}
                    <div className="flex items-center gap-3 px-4 py-3 border-b border-theme-border">
                        ...
                        <input
                            ...
                            className="flex-1 bg-transparent text-theme-fg text-lg outline-none"
                            autoFocus
                        />
                        <button
                            onClick={onClose}
                            className="p-1 hover:bg-concrete/10 rounded transition-colors"
                        >
                            ...
                            filteredFiles.map((file, index) => (
                                <div
                                    ...
                                    className={`flex items-center gap-3 px-4 py-3 cursor-pointer transition-colors ${index === selectedIndex
                                            ...
                                            : 'hover:bg-concrete/10'
                                        }`}
                                >
                                    <span className="text-2xl">{file.icon}</span>
                                    <div className="flex-1">
                                        <div className="text-theme-fg font-medium">{file.name}</div>
                    ...
                    {/* Footer hint */}
                    <div className="px-4 py-2 bg-theme-sidebar border-t border-theme-border text-xs text-concrete/50 flex gap-4">
                        <span>↑↓ Navigate</span>
                        <span>↵ Open</span>
                        <span>Esc Close</span>
                    </div>
